...
def create_identification_list(torus_complex_object):
    """ 
    Generates list of lists with entries [i,j], 
    meaning that the ith vertex has to be matched to the jth Simplex0D object
        
    create_S0 needs to be called previously.
    """
    ...
    torus_complex_object.identification_list = identification_list
...
def create_S1(torus_complex_object):
    """ 
    Generates a list of Simplex1D objects and assigns them to the input TorusComplex object.
    The Simplex1D objects contain the combinatorical representation,
    ...
    create_S0 and create_identification_list need to be called previously.
    """
...
def find_2Simplex_boundary(vertices, vertices_coordinates, S1):
    """
    Input:
        vertices ... integer filtration values of vertices
        vertices_coordinates ... coordinates (in unit cell and its duplicates) of vertices
        S1     ... list of Simplex1D objects
        
    Output:
        boundary = bound_1, bound_2, bound_3 ... three Simplex1D objects from S1 which are formed by the vertices
    """
...
def create_S2(torus_complex_object):
    """ 
    Generates a list of Simplex2D objects and assigns them to the input TorusComplex object.
        
    create_S0, create_identification_list and create_S1 need to be called previously.
    """
...
def create_S3(torus_complex_object):
    """ 
    Generates a list of Simplex3D objects and assigns them to the input TorusComplex object.
        
    create_S0, create_identification_list, create_S1 and create_S2 need to be called previously.
    """
...
def build_torus_simplices(torus_complex_object):
    for dim in range(4):
        ...
        if dim == 0:
            create_identification_list(torus_complex_object)
